var arkoseLabsClientApi03f8eff6 = function(t) {
    var e = {};
    ...
    }, n.p = "https://client-api.arkoselabs.com/v2/FE296399-FDEA-2EA2-8CD5-50F6E3157ECA/", n(n.s = 256)
}([function(t, e, n) {
    var r = n(6),
        o = n(19).f,
        i = n(17),
    ...
    t.exports = function(t, e) {
        var n, s, l, p, v, E = t.target,
            d = t.global,
            h = t.stat;
        if (n = d ? r : h ? r[E] || u(E, {}) : (r[E] || {}).prototype)
            for (s in e) {
                if (p = e[s], l = t.noTargetGet ? (v = o(n, s)) && v.value : n[s], !f(d ? s : E + (h ? "." : "#") + s, t.forced) && void 0 !== l) {
    ...
    (t.exports = function(t, e, n, s, l) {
        var p, v, E, d, h, y, g = c(e, n, s ? 2 : 1);
        if (l) p = t;
        else {
            if ("function" != typeof(v = u(t))) throw TypeError("Target is not iterable");
            if (o(v)) {
                for (E = 0, d = i(t.length); d > E; E++)
                    if ((h = s ? g(r(y = t[E])[0], y[1]) : g(t[E])) && h instanceof f) return h;
                return new f(!1)
            }
            p = v.call(t)
        }
        for (; !(y = p.next()).done;)
            if ((h = a(p, g, y.value, s)) && h instanceof f) return h;
        return new f(!1)
    }).stop = function(t) {
        return new f(!0, t)
    }
    ...
    var E = "data-".concat(r, "-event-suppress");
    e.ATTRIBUTE_EVENT_SUPPRESS = E;
    var d = "data-".concat(r, "-event-shown");
    e.ATTRIBUTE_EVENT_SHOWN = d;
    ...
    e.ENFORCEMENT_URL = "https://client-api.arkoselabs.com/v2/FE296399-FDEA-2EA2-8CD5-50F6E3157ECA/enforcement.786bfa51c2444dfeacfcfbf3f6555957.html";
    ...
    t.exports = function(t, e, n, s, v, g, T) {
        ...
        if (w && (m = i(w.call(new t)), E !== Object.prototype && m.next && (l || i(m) === E || (c ? c(m, E) : "function" != typeof m[h] && a(m, h, y)), u(m, O, !0, !0), l && (p[O] = y))), "values" == v && x && "values" !== x.name && (A = !0, N = function() {
                return x.call(this)
            }), l && !T || I[h] === N || a(I, h, N), p[e] = N, v)
            if (b = {
                    values: S("values"),
                    keys: g ? N : S("keys"),
                    entries: S("entries")
                }, T)
                for (_ in b) !d && !A && _ in I || f(I, _, b[_]);
            else r({
                target: e,
                proto: !0,
                forced: d || A
        ...
        T = new(function() {
            function t() {
                ...
                (0, i.default)(this, t), this.config = {
                    context: null,
                    target: "*"
                }, this.emitter = new u.default, this.log = d, this.logEmit = d, this.logOnWindowMessage = d, window.addEventListener("message", (function() {
                    ...
                    try {
                        ...
                        i && o === p.PUBLIC_KEY && (e.logOnWindowMessage(i, r), e.emitter.emit(i, r), "broadcast" === c && e.postMessageToParent({
                            ...
                            key: o,
                            message: i
                        }), "emit" === c && e.postMessageToChildren({
                            data: r,
                            key: o,
                            message: i
                        }))
    ...
    t.exports = function(t, e, n, d, h) {
        ...
        if (i(t, "function" != typeof y || !(h || g.forEach && !l((function() {
                (new y).entries().next()
            }))))) T = n.getConstructor(e, t, d, m), u.REQUIRED = !0;
        else if (i(t, !0)) {
            var S = new T,
                O = S[m](h ? {} : -0, 1) != S,
                A = l((function() {
            ...
            I || ((T = e((function(e, n) {
                f(e, T, t);
                var r = E(new y, e, T);
                return null != n && a(n, r[m], r, d), r
            }))).prototype = g, g.constructor = T), (A || x) && (_("delete"), _("has"), d && _("get")), (x || O) && _(m), h && g.clear && delete g.clear
        }
        return b[t] = T, r({
            global: !0,
            forced: T != y
        }, b), v(T, t), h || n.setStrong(T, t, d), T
    }
}, function(t, e, n) {
    var r = n(78),
        o = n(36),
    ...
    t.exports = {
        getConstructor: function(t, e, n, f) {
            ...
            return i(s.prototype, {
                ...
                forEach: function(t) {
                    for (var e, n = v(this), r = c(t, arguments.length > 1 ? arguments[1] : void 0, 3); e = e ? e.next : n.first;)
    ...
    var r = n(4),
        ...
        i = n(3);
    t.exports = function(t) {
        var e, n, c, u, a = arguments.length,
    ...
    o.nextTick = function(t) {
        ...
        f.push(new E(t, e)), 1 !== f.length || s || u(v)
    ...
    t.exports = n(119), n(130), n(131), n(132), n(133), n(134), n(135), n(136), n(137), n(138), n(140), n(141), n(142), n(143), n(144), n(145), n(146), n(147), n(148)
}, function(t, e, n) {
    ...
    if (i("Number", !y(" 0o1") || !y("0b1") || y("+0x1"))) {
        for (var b, _ = function(t) {
                var e = arguments.length < 1 ? 0 : t,
                    n = this;
                return n instanceof _ && (T ? l((function() {
                    g.valueOf.call(n)
                })) : "Number" != a(n)) ? f(new y(m(e)), n, _) : m(e)
            }, S = r ? v(y) : "MAX_VALUE,MIN_VALUE,NaN,NEGATIVE_INFINITY,POSITIVE_INFINITY,EPSILON,isFinite,isInteger,isNaN,isSafeInteger,MAX_SAFE_INTEGER,MIN_SAFE_INTEGER,parseFloat,parseInt,isInteger".split(","), O = 0; S.length > O; O++) u(y, b = S[O]) && !u(_, b) && d(_, b, E(y, b));
        ...
        toFixed: function(t) {
            ...
            if (a < 0 && (v = "-", a = -a), a > 1e-21)
                if (n = (e = function(t) {
                    ...
                    for (d(s(10, r, 1), 0), r = e - 1; r >= 23;) h(1 << 23), r -= 23;
                    h(1 << r), d(1, 1), h(2), E = y()
                } else d(0, n), d(1 << -e, 0), E = y() + c.call("0", l);
            return E = l > 0 ? v + ((u = E.length) <= l ? "0." + c.call("0", l - u) + E : E.slice(0, u - l) + "." + E.slice(u - l)) : v + E
        }
    })
}, function(t, e, n) {
    "use strict";
    ...
    n(169), n(173), n(175), n(176), n(177), n(178), n(179), n(180), n(181), n(182), n(183), n(184), n(185), n(187), n(188), n(189), n(190), n(191), n(192), n(193), n(194), n(48), n(195), n(196), n(197), n(198), n(199), n(200);
    var r = n(21);
    t.exports = r.Object
}, function(t, e, n) {
    "use strict";
    var r = n(0),
        ...
        it = function(t, e, n) {
            t === G && it(X, e, n), p(t);
            var r = d(e, !0);
            return p(n), f(J, r) ? (n.enumerable ? (f(t, F) && t[F][r] && (t[F][r] = !1), n = y(n, {
                enumerable: h(0, !1)
            })) : (f(t, F) || K(t, F, h(1, {})), t[F][r] = !0), nt(t, r, n)) : K(t, r, n)
        },
        ct = function(t, e) {
            p(t);
            var n = E(e),
        ...
        ut = function(t) {
            var e = d(t, !0),
                n = q.call(this, e);
            return !(this === G && f(J, e) && !f(X, e)) && (!(n || !f(this, e) || !f(J, e) || f(this, F) && this[F][e]) || n)
        },
        at = function(t, e) {
            var n = E(t),
                r = d(e, !0);
    ...
    u || (I((B = function() {
        ...
        var t = arguments.length && void 0 !== arguments[0] ? String(arguments[0]) : void 0,
            e = R(t),
            n = function(t) {
                this === G && n.call(X, t), f(this, F) && f(this[F], e) && (this[F][e] = !1), nt(this, e, h(1, t))
            };
        return c && et && nt(G, e, {
            configurable: !0,
            set: n
        ...
        return H(this).tag
    })), O.f = ut, S.f = it, _.f = at, T.f = m.f = ft, b.f = st, c && (K(B.prototype, "description", {
        configurable: !0,
        get: function() {
            return H(this).description
        }
    }), i || I(G, "propertyIsEnumerable", ut, {
        unsafe: !0
    })), L.f = function(t) {
        return rt(M(t), t)
    }), r({
    ...
    }), B.prototype[k] || A(B.prototype, k, B.prototype.valueOf), j(B, "Symbol"), w[F] = !0
}, function(t, e, n) {
    var r = n(21),
        o = n(13),
        i = n(91),
    ...
    var r = n(10),
        ...
        f = function(t) {
            var e = 1 == t,
                ...
                l = 6 == t,
                p = 5 == t || l;
            return function(v, E, d, h) {
                for (var y, g, T = i(v), m = o(T), b = r(E, d, 3), _ = c(m.length), S = 0, O = h || u, A = e ? O(v, _) : n ? O(v, 0) : void 0; _ > S; S++)
                    if ((p || S in m) && (g = b(y = m[S], S, T), t))
                        if (e) A[S] = g;
                        else if (g) switch (t) {
                    case 3:
                        return !0;
    ...
    t.exports = !s || o((function() {
        ...
        for (var n = a(t), o = arguments.length, s = 1, l = c.f, p = u.f; o > s;)
            for (var v, E = f(arguments[s++]), d = l ? i(E).concat(l(E)) : i(E), h = d.length, y = 0; h > y;) v = d[y++], r && !p.call(E, v) || (n[v] = E[v]);
        return n
    } : s
}, function(t, e, n) {
    n(0)({
    ...
    t.exports = n(202), n(204), n(205), n(206), n(208), n(209), n(210), n(211), n(212), n(213), n(214), n(215), n(216), n(217), n(218), n(219), n(220), n(221), n(222)
}, function(t, e, n) {
    ...
    (function(e) {
        for (var r = n(225), o = "undefined" == typeof window ? e : window, i = ["moz", "webkit"], c = "AnimationFrame", u = o["request" + c], a = o["cancel" + c] || o["cancelRequest" + c], f = 0; !u && f < i.length; f++) u = o[i[f] + "Request" + c], a = o[i[f] + "Cancel" + c] || o[i[f] + "CancelRequest" + c];
        if (!u || !a) {
            var s = 0,
                l = 0,
                p = [];
    ...
    Object.create && (i.prototype = Object.create(null), (new i).__proto__ || (o = !1)), f.prototype.eventNames = function() {
        ...
        if (s.fn) {
            ...
            for (f = 0; f < v; f++) switch (s[f].once && this.removeListener(t, s[f].fn, void 0, !0), l) {
                ...
                default:
                    if (!a)
                        for (p = 1, a = new Array(l - 1); p < l; p++) a[p - 1] = arguments[p];
    ...
    */
    ! function() {
        ...
        t.exports ? (c.default = c, t.exports = c) : "object" === o(n(235)) && n(235) ? void 0 === (r = function() {
            return c
    ...
    function E(t, e) {
        for (var n = [], r = {}, o = 0; o < t.length; o++) {
            ...
            r[c] ? r[c].parts.push(u) : n.push(r[c] = {
                id: c,
                parts: [u]
            })
        }
    ...
    function T(t, e) {
        ...
        if (e.singleton) {
            ...
            return void 0 === t.attrs.type && (t.attrs.type = "text/css"), t.attrs.rel = "stylesheet", g(e, t.attrs), d(t, e), e
        }(e), r = O.bind(null, n, e), o = function() {
            h(n), n.href && URL.revokeObjectURL(n.href)
        }) : (n = y(e), r = S.bind(null, n), o = function() {
            h(n)
        });
        return r(t),
            function(e) {
    ...
    var b = (0, d.default)("api:api"),
        _ = (a = {}, (0, u.default)(a, y.ATTRIBUTE_EVENT_COMPLETED, "onCompleted"), (0, u.default)(a, y.ATTRIBUTE_EVENT_HIDE, "onHide"), (0, u.default)(a, y.ATTRIBUTE_EVENT_READY, "onReady"), (0, u.default)(a, y.ATTRIBUTE_EVENT_READY_INLINE, "onReady"), (0, u.default)(a, y.ATTRIBUTE_EVENT_RESET, "onReset"), (0, u.default)(a, y.ATTRIBUTE_EVENT_SHOW, "onShow"), (0, u.default)(a, y.ATTRIBUTE_EVENT_SHOWN, "onShown"), (0, u.default)(a, y.ATTRIBUTE_EVENT_SUPPRESS, "onSuppress"), (0, u.default)(a, y.ATTRIBUTE_EVENT_LIMIT_REACHED, "onFailed"), a),
        S = {},
        O = !1,
        A = function t() {
        ...
        N = function() {
            var t = S,
                ...
                r = t.containerEl,
                o = t.events;
            b("resetting the enforcement"), S.isActive = !1, S.completed = !1, O = !1, S.timeoutCheckInlineActive && clearTimeout(S.timeoutCheckInlineActive), S.timeoutSetupInline && clearTimeout(S.timeoutSetupInline), w(), n && o && n.removeEventListener("click", o.bodyClicked), r && e && r.contains(e) && setTimeout((function() {
                r.removeChild(e)
            }), 5e3), G((0, f.default)(S)), H((0, l.default)(S, "config.mode", y.DEFAULT_MODE))
        },
        w = function() {
            var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
            try {
        ...
        j = function() {
            ...
            n !== y.INLINE_MODE && (r = [].concat((0, i.default)(r), [y.EMITTER_ENFORCEMENT_LOADED, y.EMITTER_CHALLENGE_FRAME_READY]));
            var o = S,
            ...
            f && (S.enforcementReady = !0, E.default.emit(y.EMITTER_ENFORCEMENT_READY), s === y.ATTRIBUTE_EVENT_READY && O || L(s, new A(S)), n === y.INLINE_MODE && D())
        },
        D = function() {
            return S.enforcementReady ? S.isActive ? b("Noop. Enforcement is already active") : void E.default.emit(y.EMITTER_SHOW_ENFORCEMENT) : b("Noop. Enforcement is not ready yet.")
        },
        P = function(t) {
            t.target.closest(S.config.selector) ? D() : b("Event target does not match the predefined selector `".concat(S.config.selector, "`"), t)
        },
        F = function(t) {
            return (0, l.default)(t, "keyCode") !== y.ESCAPE_KEY_CODE ? null : (0, l.default)(S, "config.settings.lightbox.closeOnEsc", !0) ? void(S.enforcementReady ? S.isActive ? E.default.emit(y.EMITTER_HIDE_ENFORCEMENT) : b("Noop. Enforcement is already hidden") : b("Noop. Enforcement is not ready yet.")) : b("Noop. close on escape is turned off")
        },
        k = function t() {
            if (S.containerEl = document.querySelector((0, l.default)(S, "config.selector", "")), S.timeoutCheckInlineActive && clearTimeout(S.timeoutCheckInlineActive), S.timeoutSetupInline && clearTimeout(S.timeoutSetupInline), S.containerEl) return S.containerEl.contains(S.appEl) || S.containerEl.appendChild(S.appEl), void
            function t() {
                (0, l.default)(S, "config.selector") && document.querySelector((0, l.default)(S, "config.selector", "")) && document.querySelector("".concat((0, l.default)(S, "config.selector"), ' > div > [title="').concat(y.ENFORCEMENT_FRAME_TITLE, '"]')) ? S.timeoutCheckInlineActive = setTimeout(t, y.INLINE_ELEMENT_CHECK_FREQ) : S.completed || N()
            }();
        ...
        U = function() {
            ...
            (S = x({
                ...
                appEl: r,
                enforcementReady: o
            })).events.bodyClicked = function() {
                return P.apply(void 0, arguments)
            }, S.events.escapePressed = function() {
                return F.apply(void 0, arguments)
            }, i && n && (i.removeEventListener("click", n.bodyClicked), window.removeEventListener("keyup", n.escapePressed)), S.bodyElement.addEventListener("click", S.events.bodyClicked), window.addEventListener("keyup", S.events.escapePressed), S.previousState = (0, f.default)(c);
            var u = S.elements()[0],
                a = (0, p.default)(u, "getAttribute", y.ATTRIBUTE_CONTAINER_SELECTOR);
            S.containerEl = document.querySelector(a || "body"), S.containerEl.contains(S.appEl) || S.containerEl.appendChild(S.appEl)
        },
        H = function() {
            var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : y.DEFAULT_MODE;
            switch (t) {
                case y.INLINE_MODE:
                    O || (O = !0, L(y.ATTRIBUTE_EVENT_READY_INLINE, new A(S))), k();
                    break;
                default:
                    U(S)
            }
        ...
        G = function() {
            ...
            (S = x({
                ...
                events: n,
                completed: r
            })).previousState = (0, f.default)(t), M(m({
                challengeApiUrl: e && e.challengeApiUrl
            }, e))
        },
        B = function() {
            var t, e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
                ...
                l = void 0 === s ? {} : s,
                p = (0, o.default)(e, ["challengeApiUrl", "data", "language", "mode", "selector", "styleTheme", "accessibilitySettings"]);
            S.events = m({}, S.events, (t = {}, (0, u.default)(t, "onCompleted", p.onCompleted || S.events.onCompleted), (0, u.default)(t, "onFailed", p.onFailed || S.events.onFailed), (0, u.default)(t, "onHide", p.onHide || S.events.onHide), (0, u.default)(t, "onReady", p.onReady || S.events.onReady), (0, u.default)(t, "onReset", p.onReset || S.events.onReset), (0, u.default)(t, "onShow", p.onShow || S.events.onShow), (0, u.default)(t, "onShown", p.onShown || S.events.onShown), (0, u.default)(t, "onSuppress", p.onSuppress || S.events.onSuppress), t));
            ...
            M({
                ...
                settings: {
                    language: i || S.config.settings.language
                },
                accessibilitySettings: l
            }), H(c)
        };
    E.default.on(y.EMITTER_GAME_NUMBER_LIMIT_REACHED, (function() {
        var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
        S.token = t.token, L(y.ATTRIBUTE_EVENT_LIMIT_REACHED, new A(S), t)
    })), E.default.on(y.EMITTER_CHALLENGE_COMPLETED, (function() {
        var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
        S.completed = !0, S.token = t.token, L(y.ATTRIBUTE_EVENT_COMPLETED, new A(S), t)
    })), E.default.on(y.EMITTER_CHALLENGE_FRAME_READY, j), E.default.on(y.EMITTER_CHALLENGE_LOADED, j), E.default.on(y.EMITTER_CHALLENGE_SUPPRESSED, (function() {
        b("onChallengeSuppressed"), S.isActive = !1, S.suppressed = !0, w(), L(y.ATTRIBUTE_EVENT_SUPPRESS, new A(S))
    })), E.default.on(y.EMITTER_CHALLENGE_SHOWN, (function() {
        b("onChallengeShown"), S.isActive = !0, w({
            overrideShowDelay: !0
        }), L(y.ATTRIBUTE_EVENT_SHOWN, new A(S))
    })), E.default.on(y.EMITTER_CONFIG_REQUEST, M), E.default.on(y.EMITTER_ENFORCEMENT_LOADED, (function(t) {
        S.enforcementLoaded = !0, M(t), j({
            event: y.EMITTER_ENFORCEMENT_LOADED
        }), w()
    })), E.default.on(y.EMITTER_HIDE_ENFORCEMENT, (function() {
        b("hide enforcement"), S.isActive = !1, S.savedActiveElement && (S.savedActiveElement.focus(), S.savedActiveElement = null), L(y.ATTRIBUTE_EVENT_HIDE, new A(S)), (0, l.default)(S, "config.accessibilitySettings.lockFocusToModal") && function() {
            for (var t = S.modifiedSiblings, e = 0, n = t.length; e < n; e++) {
                var r = t[e],
                    o = r.elem,
                    i = r.ariaHiddenState;
                o !== S.appEl && (null === i ? o.removeAttribute("aria-hidden") : o.setAttribute("aria-hidden", i))
            }
        }(), setTimeout((function() {
            w(), C(!0), S.completed && N()
        }), 1.05 * y.ENFORCEMENT_HIDE_TRANSITION_MS)
    })), E.default.on(y.EMITTER_SHOW_ENFORCEMENT, (function() {
        b("show enforcement"), S.isActive = !0, S.savedActiveElement = document.activeElement, L(y.ATTRIBUTE_EVENT_SHOW, new A(S)), (0, l.default)(S, "config.accessibilitySettings.lockFocusToModal") && function() {
            var t = S.bodyElement.children;
            S.modifiedSiblings = [];
            for (var e = 0, n = t.length; e < n; e++) {
                var r = t.item(e),
                    o = r.getAttribute("aria-hidden");
                r !== S.appEl && "true" !== o && (S.modifiedSiblings.push({
                    elem: r,
                    ariaHiddenState: o
                }), r.setAttribute("aria-hidden", !0))
            }
        }(), w(), C(!1)
    })), E.default.on(y.EMITTER_CHALLENGE_RESET, (function() {
        S.isActive = !1, S.enforcementReady = !1, S.challengeLoadedEvents = [y.EMITTER_CHALLENGE_FRAME_READY], S.isResettingChallenge = !0
    })), E.default.on(y.EMITTER_ENFORCEMENT_READY, (function() {
    ...
    V ? function t() {
        if (!(0, v.isFunction)(window[V])) return b("Invoking callback window.".concat(V, "() failed. Will retry.")), setTimeout(t, 1e3);
        G(), window[V]({
            setConfig: B,
            getConfig: R,
            reset: N,
            run: D,
            version: y.PACKAGE_VERSION
        })
    }() : (G(), U())
}, function(t, e, n) {
    var r = n(258);
    ...
    O["[object Arguments]"] = O["[object Array]"] = O["[object ArrayBuffer]"] = O["[object DataView]"] = O["[object Boolean]"] = O["[object Date]"] = O["[object Float32Array]"] = O["[object Float64Array]"] = O["[object Int8Array]"] = O["[object Int16Array]"] = O["[object Int32Array]"] = O["[object Map]"] = O["[object Number]"] = O["[object Object]"] = O["[object RegExp]"] = O["[object Set]"] = O["[object String]"] = O["[object Symbol]"] = O["[object Uint8Array]"] = O["[object Uint8ClampedArray]"] = O["[object Uint16Array]"] = O["[object Uint32Array]"] = !0, O["[object Error]"] = O["[object Function]"] = O["[object WeakMap]"] = !1, t.exports = function t(e, n, A, I, x, N) {
        var w, R = 1 & n,
            M = 2 & n,
            L = 4 & n;
        if (A && (w = x ? A(e, I, x, N) : A(e)), void 0 !== w) return w;
        if (!b(e)) return e;
        var C = g(e);
        if (C) {
            if (w = d(e), !R) return f(e, w)
        } else {
            var j = E(e),
        ...
        var P = N.get(e);
        if (P) return P;
        N.set(e, w), _(e) ? e.forEach((function(r) {
            w.add(t(r, n, A, r, e, N))
        })) : m(e) && e.forEach((function(r, o) {
            w.set(o, t(r, n, A, o, e, N))
        }));
        var F = L ? M ? v : p : M ? keysIn : S,
            k = C ? void 0 : F(e);
        return o(k || e, (function(r, o) {
            k && (r = e[o = r]), i(w, o, t(r, n, A, o, e, N))
        })), w
    }
}, function(t, e, n) {
    var r = n(267),
    ...
    u.default.on(a.EMITTER_CHALLENGE_IFRAME, (function(t) {
        var e = t.width,
            n = t.height;
        l && (e && e !== l.style.width && (l.style.width = e, p = e), n && n !== l.style.height && (l.style.height = n, v = n), document.activeElement !== l && l.focus())
    }));
    var d = function(t) {
        var e = t.appElement,
            n = t.config,
        ...
        s.appElement = e, s.showDelay = p, s.mode = (0, i.default)(n, "mode"), u === s.overrideShowDelay && r === s.isActive || (s.isActive = r, s.overrideShowDelay = u, s.timer && (s.show = !1, clearTimeout(s.timer)), s.timer = setTimeout((function() {
            if (s.isActive) {
                s.show = !0;
                var t = (0, c.default)(f.default.container, (0, o.default)({
                    show: !0,
                    active: !0
                }, s.mode || a.DEFAULT_MODE, !0));
                E(s.appElement, t)
            }
        }), s.showDelay));
        var v = (0, c.default)(f.default.container, (0, o.default)({
            show: !!s.show,
            active: !!s.isActive
        }, s.mode || a.DEFAULT_MODE, !0));
        if ((0, i.default)(e, "children", []).length < 1) {
            var d = document.createElement("iframe");
            d.setAttribute("src", a.ENFORCEMENT_URL), d.setAttribute("class", v), d.setAttribute("title", a.ENFORCEMENT_FRAME_TITLE), d.setAttribute("data-e2e", "enforcement-frame");
            var h = (0, i.default)(n, "theme.container.style", {});
            Object.keys(h).map((function(t) {
                d.style[t] = h[t]
            })), e.appendChild(d), l = d
        } else(0, i.default)(e, "childNodes[0].className") !== v && E(e, v)
    };
    e.default = d
}, function(t, e, n) {
    var r = n(309);
