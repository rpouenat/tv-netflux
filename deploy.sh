...
echo "ExecStart=/home/download/Scripts/tv-netflux/venv/bin/gunicorn --preload --workers 3 --bind 0.0.0.0:5000 -m 007 wsgi:app --access-logfile /var/log/tv-netflux/access.log --error-logfile /var/log/tv-netflux/error.log --timeout 18000" >> /etc/systemd/system/tv-netflux.service
echo "" >> /etc/systemd/system/tv-netflux.service
...
echo "alias updateapitorrentdownload='cd ~/Scripts/tv-netflux ; git pull ; sudo service tv-netflux restart'" >> ~/.bashrc ; source ~/.bashrc
