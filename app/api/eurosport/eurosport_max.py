		...
		if "data" in data_json:
			if "programsByDate" in data_json["data"]:
				if "edges" in data_json["data"]["programsByDate"]:
					...
					for program in data_output:
						img_name = program["node"]["picture"]["url"].split("/")[-1]
						# print(program)
						if program["node"]["status"] != "ONAIR":
							# print(json.dumps(program, indent=1))
							# On récupère la base 64

							url_img = "https://imgresizer.eurosport.com/unsafe/630x0/smart/i.eurosport.com/taiga/Specifique/Crop/16_9/" + img_name
							program["node"]["picture"]["url"] = url_img

						else:
							print(program["node"]["picture"]["url"])
							url_img = "https://imgresizer.eurosport.com/unsafe/364x546/filters:format(webp)/origin-imgresizer.eurosport.com/taiga/Specifique/Crop/3_4/"
							program["node"]["picture"]["url"] = url_img
							# https://imgresizer.eurosport.com/unsafe/364x546/filters:format(webp)/origin-imgresizer.eurosport.com/taiga/Specifique/Crop/3_4/20057_3_200207220_20240617-084125.jpeg


							# https://imgresizer.eurosport.com/unsafe/630x0/smart/i.eurosport.com/taiga/Specifique/Crop/16_9/20057_3_200207220_20240617-084124.jpeg
							# https://imgresizer.eurosport.com/unsafe/200x200/smart/i.eurosport.com/taiga/Specifique/Crop/16_9/203_3_200032658_20240616-152737.jpeg
							# https://tv.netflux.fun:2087/tv/eurosport/img/unsafe/89x67/smart/origin-imgresizer.eurosport.com/taiga/Specifique/Crop/16_9/3_3_200063159_20240326-133644.jpeg
